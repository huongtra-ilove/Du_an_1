...
$(document).ready(function() {
    ...
    if (in_array(storeId, [93682, 15113])) {
        ...
        if (in_array(storeId, [117665, 9980])) {
            if ($('.newsletter-input-mobile').val() == '') {
                ...
                AppAjax.post('/newsletter/subscribe', {
                        'mail': email,
                        'mobile': $('.newsletter-input-mobile').val()
                    },
                    function(rs) {
                        if (rs.code) {
    ...
    if (proLoop.length) {
        proLoop.each(function() {
            // if (in_array(storeId, [92233,1642,15113])) {
    ...
    // if(in_array(storeId, [92233, 1642])) {
    ...
    if (in_array(storeId, [25366, 15113])) {
